...
# side is a many to one, specify an additional relationship() and connect the
# two using the relationship.back_populates parameter:
...
# collection. Specify using relationship.back_populates, and for each
