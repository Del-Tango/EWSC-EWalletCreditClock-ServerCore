...
class TestEWalletSessionManagerMasterViewAccount(unittest.TestCase):
    ...
    def test_master_action_view_account_functionality(self):
        ...
        self.assertEqual(view.get('account'), self.user_email_3)
