...
class TestEWalletSessionManageUserActionPayCredits(unittest.TestCase):
    ...
    def test_user_action_pay_credits_to_partner(self):
        '''
        [ NOTE ]: Instruction Set Details
            - pay = Target user email address
        '''
        print('\n[ * ]: User action PayCredits')
        instruction_set = {
        ...
        self.assertTrue(isinstance(pay.get('invoice_record'), int))
