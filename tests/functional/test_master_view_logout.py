...
class TestEWalletSessionManagerMasterViewLogoutRecords(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        print('[...]: Master action AccountLogout')
        logout = cls.session_manager.session_manager_controller(
    ...
    def test_master_action_view_logout_records_functionality(self):
        print('\n[ * ]: Master action ViewLogoutRecords')
        instruction_set = {
