...
class TestEWalletSessionManageUserActionUnlinkConversionRecord(unittest.TestCase):
    ...
    def test_user_action_unlink_conversion_record(self):
        print('\n[ * ]: User action UnlinkConversionRecord')
        instruction_set = {
        ...
        self.assertTrue(isinstance(unlink.get('conversion_sheet'), int))
        self.assertTrue(isinstance(unlink.get('conversion_record'), int))
