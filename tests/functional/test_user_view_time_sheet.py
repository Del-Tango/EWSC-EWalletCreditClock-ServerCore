...
class TestEWalletSessionManageUserActionViewTimeSheet(unittest.TestCase):
    ...
    def test_user_action_view_time_sheet(self):
        ...
        view = self.session_manager.session_manager_controller(
            ...
            time='list', client_id=self.client_id, session_token=self.session_token
        )
        print(str(view) + '\n')
        ...
        self.assertTrue(isinstance(view['sheet_data'].get('time_sheet_id'), int))
