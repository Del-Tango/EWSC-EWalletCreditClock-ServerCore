...
class TestEWalletSessionManagerUserCTokenKeepAlive(unittest.TestCase):
    ...
    def test_user_action_ctoken_keep_alive_functionality(self):
        ...
        self.assertTrue(isinstance(keep_alive.get('ctoken'), str))
        self.assertTrue(isinstance(keep_alive.get('extended'), int))
        self.assertTrue(isinstance(keep_alive.get('time_unit'), str))
        self.assertTrue(isinstance(keep_alive.get('ctoken_data'), dict))
