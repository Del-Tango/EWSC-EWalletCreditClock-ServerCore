...
class TestEWalletSessionManageUserActionUnlinkCreditEWallet(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # Create credit ewallet for action unlink
        print('[...]: User action CreateCreditEWallet')
    ...
    def test_user_action_unlink_credit_ewallet(self):
        print('\n[ * ]: User action UnlinkCreditEWallet')
        instruction_set = {
        ...
        self.assertTrue(isinstance(unlink.get('credit_ewallet'), int))
