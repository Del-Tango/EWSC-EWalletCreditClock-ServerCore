...
class TestEWalletSessionManageUserActionSwitchTimeSheet(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # Create second time sheet to have for user action switch
    ...
    def test_user_action_switch_time_sheet(self):
        ...
        self.assertTrue(isinstance(switch.get('time_sheet'), int))
        self.assertTrue(isinstance(switch.get('sheet_data'), dict))
        self.assertTrue(isinstance(switch['sheet_data'].get('time_sheet_id'), int))
        self.assertTrue(isinstance(switch['sheet_data'].get('clock_id'), int))
