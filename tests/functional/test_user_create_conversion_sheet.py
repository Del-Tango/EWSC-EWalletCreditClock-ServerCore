...
class TestEWalletSessionManageUserActionCreateConversionSheet(unittest.TestCase):
    ...
    def test_user_action_create_conversion_sheet(self):
        ...
        create = self.session_manager.session_manager_controller(
            ...
            conversion='list', client_id=self.client_id,
        ...
        self.assertTrue(isinstance(create.get('conversion_sheet'), int))
