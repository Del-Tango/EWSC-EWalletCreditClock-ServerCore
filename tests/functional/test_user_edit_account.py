...
class TestEWalletSessionManageUserActionEditAccount(unittest.TestCase):
    ...
    def test_user_action_edit_account(self):
        ...
        self.assertTrue(isinstance(edit['edit'].get('name'), bool))
        self.assertTrue(isinstance(edit['edit'].get('pass'), bool))
        self.assertTrue(isinstance(edit['edit'].get('alias'), bool))
        self.assertTrue(isinstance(edit['edit'].get('email'), bool))
        self.assertTrue(isinstance(edit['edit'].get('phone'), bool))
        self.assertTrue(isinstance(edit.get('account_data'), dict))
        self.assertTrue(isinstance(edit['account_data'].get('id'), int))
        self.assertTrue(isinstance(edit['account_data'].get('name'), str))
        ...
        self.assertTrue(isinstance(edit['account_data'].get('ewallet'), int))
