...
class TestEWalletSessionManageUserActionUnlinkInvoiceSheet(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # Create invoice sheet for action unlink
    ...
    def test_user_action_unlink_invoice_sheet(self):
        print('\n[ * ]: User action UnlinkInvoiceSheet')
        instruction_set = {
            'controller': 'client', 'ctype': 'action', 'action': 'unlink',
            'unlink': 'invoice', 'invoice': 'list', 'list_id': 3,
