...
class TestEWalletSessionManagerUserSupplyCredits(unittest.TestCase):
    ...
    def test_user_action_supply_credits_functionality(self):
        ...
        self.assertTrue(isinstance(supply, dict))
        self.assertEqual(len(supply.keys()), 5)
