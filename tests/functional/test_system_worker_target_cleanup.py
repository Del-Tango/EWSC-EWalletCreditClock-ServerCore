...
class TestEWalletSessionManagerSystemWorkerTargetCleanup(unittest.TestCase):
    ...
    def test_system_action_target_cleanup_worker_functionality(self):
        print('\n[ * ]: System action TargetCleanupWorker')
        instruction_set = {
            'controller': 'system', 'ctype': 'action', 'action': 'cleanup',
            'cleanup': 'workers', 'worker_id': 2,
        }
