...
class TestEWalletSessionManageUserActionCreateContactList(unittest.TestCase):
    ...
    def test_user_action_create_contact_list(self):
        ...
        self.assertTrue(isinstance(create['list_data'].get('records'), dict))
