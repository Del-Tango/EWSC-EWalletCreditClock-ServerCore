...
class TestEWalletSessionManageUserActionViewAccount(unittest.TestCase):
    ...
    def test_user_action_view_account(self):
        ...
        self.assertTrue(isinstance(view['account_data'].get('user_name'), str))
        ...
        self.assertTrue(isinstance(view['account_data'].get('credit_wallet'), int))
        self.assertTrue(isinstance(view['account_data'].get('contact_list'), int))
        self.assertTrue(isinstance(view['account_data'].get('user_email'), str))
        self.assertTrue(isinstance(view['account_data'].get('user_phone'), str))
        self.assertTrue(isinstance(view['account_data'].get('user_alias'), str))
        self.assertTrue(isinstance(view['account_data'].get('state_code'), int))
        self.assertTrue(isinstance(view['account_data'].get('state_name'), str))
        self.assertTrue(isinstance(view['account_data'].get('credit_wallet_archive'), dict))
