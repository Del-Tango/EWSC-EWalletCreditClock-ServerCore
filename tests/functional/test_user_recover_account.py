...
class TestEWalletSessionManageUserActionRecoverAccount(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # Mark active session account for deletion
    ...
    def test_user_action_recover_user_account(self):
        print('\n[ * ]: User action RecoverAccount')
        instruction_set = {
            'controller': 'client', 'ctype': 'action', 'action': 'recover',
