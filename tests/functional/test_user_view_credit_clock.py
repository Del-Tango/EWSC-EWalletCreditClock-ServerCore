...
class TestEWalletSessionManageUserActionViewCreditClock(unittest.TestCase):
    ...
    def test_user_action_view_credit_clock(self):
        ...
        self.assertTrue(isinstance(view.get('credit_clock'), int))
        self.assertTrue(isinstance(view.get('clock_data'), dict))
        self.assertTrue(isinstance(view['clock_data'].get('id'), int))
        self.assertTrue(isinstance(view['clock_data'].get('wallet_id'), int))
        self.assertTrue(isinstance(view['clock_data'].get('reference'), str))
        self.assertTrue(isinstance(view['clock_data'].get('create_date'), str))
        self.assertTrue(isinstance(view['clock_data'].get('write_date'), str))
        self.assertTrue(isinstance(view['clock_data'].get('credit_clock'), float))
        self.assertTrue(isinstance(view['clock_data'].get('credit_clock_state'), str))
        self.assertTrue(isinstance(view['clock_data'].get('time_sheet'), int))
        self.assertTrue(isinstance(view['clock_data'].get('time_sheet_archive'), dict))
        self.assertTrue(isinstance(view['clock_data'].get('conversion_sheet'), int))
        self.assertTrue(isinstance(view['clock_data'].get('conversion_sheet_archive'), dict))
