...
class TestEWalletSessionManageUserActionViewCreditClock(unittest.TestCase):
    ...
    def test_user_action_view_credit_clock(self):
        ...
        self.assertTrue(isinstance(view['clock_data'].get('clock_state'), str))
