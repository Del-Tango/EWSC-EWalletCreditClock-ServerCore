...
class TestEWalletSessionManageUserActionSwitchCreditEWallet(unittest.TestCase):
    ...
    def test_user_action_switch_credit_ewallet(self):
        ...
        self.assertTrue(isinstance(switch.get('credit_ewallet'), int))
        self.assertTrue(isinstance(switch.get('ewallet_data'), dict))
        self.assertTrue(isinstance(switch['ewallet_data'].get('id'), int))
        self.assertTrue(isinstance(switch['ewallet_data'].get('client_id'), int))
        ...
        self.assertTrue(isinstance(switch['ewallet_data'].get('credit_clock'), int))
        self.assertTrue(isinstance(switch['ewallet_data'].get('credit_clock_archive'), dict))
