...
class TestEWalletSessionManageUserActionCreateTimeSheet(unittest.TestCase):
    ...
    def test_user_action_create_time_sheet(self):
        ...
        create = self.session_manager.session_manager_controller(
            ...
            time='list', client_id=self.client_id,
        ...
        self.assertTrue(isinstance(create.get('time_sheet'), int))
        self.assertTrue(isinstance(create.get('sheet_data'), dict))
        self.assertTrue(isinstance(create['sheet_data'].get('time_sheet_id'), int))
        self.assertTrue(isinstance(create['sheet_data'].get('clock_id'), int))
