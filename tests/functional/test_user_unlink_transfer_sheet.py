...
class TestEWalletSessionManageUserActionUnlinkTransferSheet(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # Create transfer sheet for action unlink
    ...
    def test_user_action_unlink_transfer_sheet(self):
        ...
        unlink = self.session_manager.session_manager_controller(
            ...
            transfer='list', list_id=2, client_id=self.client_id,
