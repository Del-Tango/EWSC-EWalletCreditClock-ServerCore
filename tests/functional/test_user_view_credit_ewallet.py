...
class TestEWalletSessionManageUserActionViewCreditEWallet(unittest.TestCase):
    ...
    def test_user_action_view_credit_ewallet(self):
        ...
        self.assertTrue(isinstance(view.get('credit_ewallet'), int))
        self.assertTrue(isinstance(view.get('ewallet_data'), dict))
        self.assertTrue(isinstance(view['ewallet_data'].get('id'), int))
        self.assertTrue(isinstance(view['ewallet_data'].get('client_id'), int))
        ...
        self.assertTrue(isinstance(view['ewallet_data'].get('credit_clock'), int))
        self.assertTrue(isinstance(view['ewallet_data'].get('credit_clock_archive'), dict))
