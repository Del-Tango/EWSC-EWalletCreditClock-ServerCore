...
class TestEWalletSessionManagerMasterViewLoginRecords(unittest.TestCase):
    ...
    def test_master_action_view_login_records_functionality(self):
        print('\n[ * ]: Master action ViewLoginRecords')
        instruction_set = {
            'controller': 'master', 'ctype': 'action', 'action': 'view',
            'view': 'login', 'client_id': self.client_id,
        ...
        self.assertTrue(isinstance(view.get('login_records'), dict))
