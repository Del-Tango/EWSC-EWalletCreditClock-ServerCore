...
class TestEWalletSessionManageUserActionCreateCreditEWallet(unittest.TestCase):
    ...
    def test_user_action_create_credit_ewallet(self):
        ...
        create = self.session_manager.session_manager_controller(
            ...
            credit='ewallet', client_id=self.client_id,
        ...
        self.assertTrue(isinstance(create.get('credit_ewallet'), int))
        self.assertTrue(isinstance(create.get('ewallet_data'), dict))
        self.assertTrue(isinstance(create['ewallet_data'].get('id'), int))
        self.assertTrue(isinstance(create['ewallet_data'].get('client_id'), int))
        ...
        self.assertTrue(isinstance(create['ewallet_data'].get('credit_clock'), int))
        self.assertTrue(isinstance(create['ewallet_data'].get('credit_clock_archive'), dict))
