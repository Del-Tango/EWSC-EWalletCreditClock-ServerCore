...
class TestEWalletSessionManagerSystemActionStartCTokenCleanerCron(unittest.TestCase):
    ...
    def test_system_action_start_client_token_cleaner_cron_functionality(self):
        print('\n[ * ]: System action StartCTokenCleaner')
        instruction_set = {
            'controller': 'system', 'ctype': 'action', 'action': 'start',
            'start': 'cleaner', 'clean': 'ctokens',
        }
