...
class TestEWalletSessionManageUserActionUnlinkContactList(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # Create contact list for action unlink
        print('[...]: User action CreateContactList')
    ...
    def test_user_action_unlink_contact_list(self):
        print('\n[ * ]: User action UnlinkContactList')
        instruction_set = {
